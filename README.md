# 👋 Bonjour, je suis lighscent

> **Développeur Backend** · JavaScript / Node.js
>
> `const goal = "Build & maintain a webchat in 2026";`

---

## 🧑‍💻 À propos

- 💻 Développeur Backend passionné par les architectures serveur
- 🔐 En cours d'apprentissage : authentification (JWT, OAuth, sessions)
- 🎯 Objectif 2026 : Concevoir, déployer et maintenir un webchat en production
- 🌍 Basé en France
...
| Objectif | Statut |
|---|---|
| Maîtriser l'authentification complète | 🟡 En cours |
| Développer un webchat full-stack | 🔵 Démarré |
| Déploiement et maintenance en production | ⚪ À venir |
...
⭐ N'hésite pas à star mes repos s'ils te sont utiles !